----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
# <p align='center'> A Vérifier  </p>
----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
## I. Compilation et installation du kernel 6.15
...
```
août 11 23:45:33 Debian kernel: Error: Driver 'pcspkr' is already registered, aborting...
```
